...
plot(0, 0, type="n", xlim=c(0,500), ylim=c(0,400), xlab="Connections Predicted", ylab="False Positives")
legend(0, 200, c("SPACE", "WGCNA", "GeneNet", "ENA"), col=colors, lwd=3, lty=1:4, y.intersp=1.5)
