...
plot(0, 0, type="n", xlim=c(0,50), ylim=c(0,35), xlab="Predicted Connection Strength", ylab="False Positive Strength")
...
plot(0, 0, type="n", xlim=c(0,50), ylim=c(0,30), xlab="Predicted Connection Strength", ylab="")
